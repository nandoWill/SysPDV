...
struct qt_meta_stringdata_RealizarVenda_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RealizarVenda_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RealizarVenda_t qt_meta_stringdata_RealizarVenda = {
    {
QT_MOC_LITERAL(0, 0, 13) // "RealizarVenda"
...
const QMetaObject RealizarVenda::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_RealizarVenda.data,
      qt_meta_data_RealizarVenda,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RealizarVenda::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RealizarVenda.stringdata0))
